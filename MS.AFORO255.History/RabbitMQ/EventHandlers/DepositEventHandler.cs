...
{
    public class DepositEventHandler : IEventHandler<DepositCreatedEvent> //ESTA INTERFAZ ESTA EN EL PROYECTO DE RABBIT PERMITE TRABAJAR CON LOS EVENTOS DE ESA COLA
    {
