...
namespace MS.AFORO255.Deposit
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IRequestHandler<DepositCreateCommand, bool>, DepositCommandHandler>();  //cada vez que lance un comando el handler debe de capturarlo
            ...
            /*Start Proxy - para la comunicacion mediante el protocolo HTTP entre microservicios*/
